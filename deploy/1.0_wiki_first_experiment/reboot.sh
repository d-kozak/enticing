...
./scripts/kill_screens.sh "$ENTICING_HOME"/deploy/1.0_wiki_first_experiment/martin_limit.txt || exit 1
ssh "xkozak15@$webserver_server screen -S $webserver_screen_name -X quit" || exit 1
echo "1/5 All running screens were killed"
