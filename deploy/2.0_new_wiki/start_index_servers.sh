...
parallel-ssh -l xkozak15 -h "${ENTICING_HOME}/deploy/2.0_new_wiki/servers.txt" -i "cd /mnt/minerva1/nlp/projects/corpproc_search/corpproc_search/ && /opt/anaconda3/bin/python3.6 ./scripts/node/start_server.py /mnt/data/indexes/xkozak15/new_wiki ${ENTICING_HOME}/deploy/2.0_new_wiki/client.config.kts enticing-index-server-2-wiki 5628 /mnt/data/indexes/xkozak15/new_wiki/indexserver.log"
