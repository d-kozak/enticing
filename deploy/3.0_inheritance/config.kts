...
enticingConfiguration {
    ...
    deployment {
        ...
        configurationScript = "$repository/deploy/3.0_inheritance/config.kts"
        buildId = "release"
    }

    corpusConfig {
        corpus("wiki-2018") {
            collectionsDir = "/mnt/data/indexes/xkozak15/wiki-2020-inheritance"
            serverFile("$ENTICING_HOME/deploy/3.0_inheritance/servers.txt")
