...
public class EqlBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements EqlVisitor<T> {
	 ...
	 */
    @Override
    public T visitParen(EqlParser.ParenContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitBinaryOperation(EqlParser.BinaryOperationContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitUnaryOperation(EqlParser.UnaryOperationContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitLiteral(EqlParser.LiteralContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitOrder(EqlParser.OrderContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitAlignOperator(EqlParser.AlignOperatorContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitAssignment(EqlParser.AssignmentContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitPar(EqlParser.ParContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
	 ...
	 */
    @Override
    public T visitProximity(EqlParser.ProximityContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
     ...
     */
    @Override
    public T visitConstraint(EqlParser.ConstraintContext ctx) {
        return visitChildren(ctx);
    }
	/**
	 * {@inheritDoc}
     ...
     */
    @Override
    public T visitUnaryOperator(EqlParser.UnaryOperatorContext ctx) {
        return visitChildren(ctx); }
}