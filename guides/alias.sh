...
alias client-local=java -cp "*:mg4j-bin/*" cz.vutbr.fit.knot.index.client.MainKt ../console-client/src/test/resources/client.config.local.kts
alias client-local=java -cp "*:mg4j-bin/*" cz.vutbr.fit.knot.index.client.MainKt ../console-client/src/test/resources/client.config.remote.kts
