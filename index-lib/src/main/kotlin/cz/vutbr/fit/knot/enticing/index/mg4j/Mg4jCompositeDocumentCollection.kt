...
class Mg4jCompositeDocumentCollection(
    ...
    private val factory = Mg4jDocumentFactory(metadataConfiguration, loggerFactory)

    private val singleFileCollections = files.map { Mg4jSingleFileDocumentCollection(it, factory.copy(), loggerFactory) }
    ...
    override fun copy(): DocumentCollection = Mg4jCompositeDocumentCollection(metadataConfiguration, files, loggerFactory)
