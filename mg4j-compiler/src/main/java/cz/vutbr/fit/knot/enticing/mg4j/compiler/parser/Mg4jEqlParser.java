...
public class Mg4jEqlParser extends Parser {
    ...
    public static final int
            ...
            WORD = 24;
    public static final int
            RULE_root = 0, RULE_query = 1, RULE_queryPart = 2, RULE_queryCore = 3,
            RULE_literal = 4, RULE_alignOperator = 5, RULE_identifier = 6, RULE_limitation = 7,
            RULE_indexOperator = 8, RULE_constraint = 9, RULE_reference = 10, RULE_relOp = 11,
            RULE_binaryOperator = 12, RULE_unaryOperator = 13;

    private static String[] makeRuleNames() {
        return new String[]{
                "root", "query", "queryPart", "queryCore", "literal", "alignOperator",
                "identifier", "limitation", "indexOperator", "constraint", "reference",
                "relOp", "binaryOperator", "unaryOperator"
        };
    }
    ...
    public static class QueryPartContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_queryPart;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof Mg4jEqlListener) ((Mg4jEqlListener) listener).enterQueryPart(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof Mg4jEqlListener) ((Mg4jEqlListener) listener).exitQueryPart(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof Mg4jEqlVisitor) return ((Mg4jEqlVisitor<? extends T>) visitor).visitQueryPart(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final QueryPartContext queryPart() throws RecognitionException {
        ...
        enterRule(_localctx, 4, RULE_queryPart);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(41);
    ...
    public static class SequenceContext extends QueryCoreContext {
        ...
        public SequenceContext(QueryCoreContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ParenContext extends QueryCoreContext {
        ...
        public ParenContext(QueryCoreContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LitContext extends QueryCoreContext {
        ...
        public LitContext(QueryCoreContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BinaryOperationContext extends QueryCoreContext {
        ...
        public QueryPartContext queryPart() {
            return getRuleContext(QueryPartContext.class, 0);
        }

        public BinaryOperationContext(QueryCoreContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class UnaryOperationContext extends QueryCoreContext {
        ...
        public UnaryOperationContext(QueryCoreContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class OrderContext extends QueryCoreContext {
        ...
        public OrderContext(QueryCoreContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class AlignOperatorContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof Mg4jEqlVisitor)
                return ((Mg4jEqlVisitor<? extends T>) visitor).visitAlignOperator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static final String _serializedATN =
            "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\32\u009a\4\2\t\2" +
                    ...
                    "\20\2\4\6\b\n\f\16\20\22\24\26\30\32\34\2\5\3\2\31\32\3\2\f\21\3\2\25" +
                    ...
                    "\3\2\2\2_`\7\32\2\2`a\7\3\2\2a\17\3\2\2\2bc\7\4\2\2ci\7\t\2\2de\7\4\2" +
                    "\2ei\7\b\2\2fg\7\7\2\2gi\7\31\2\2hb\3\2\2\2hd\3\2\2\2hf\3\2\2\2i\21\3" +
                    "\2\2\2jk\7\32\2\2km\7\24\2\2lj\3\2\2\2mp\3\2\2\2nl\3\2\2\2no\3\2\2\2o" +
                    "q\3\2\2\2pn\3\2\2\2qr\7\32\2\2rs\7\5\2\2s\23\3\2\2\2tu\b\13\1\2uv\7\22" +
                    "\2\2vw\5\24\13\2wx\7\23\2\2x\u0085\3\2\2\2yz\5\26\f\2z{\5\30\r\2{|\5\26" +
                    "\f\2|\u0085\3\2\2\2}~\5\26\f\2~\177\5\30\r\2\177\u0080\7\32\2\2\u0080" +
                    ...
                    "\32\2\2\u0092\27\3\2\2\2\u0093\u0094\t\3\2\2\u0094\31\3\2\2\2\u0095\u0096" +
