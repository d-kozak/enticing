...
class QueryConfig {
    ...
    @Bean
    fun queryDispatcher(@Value("\${index.server.api.base.path}") apiBasePath: String, loggerFactory: LoggerFactory): QueryDispatcher<SearchQuery, Map<CollectionName, Offset>, IndexServer.IndexResultList> = QueryDispatcher(FuelQueryExecutor("$apiBasePath/query"), loggerFactory)
