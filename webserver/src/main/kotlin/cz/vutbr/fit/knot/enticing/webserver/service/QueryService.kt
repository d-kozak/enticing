...
class QueryService {
    ...
    fun context(query: ContextExtensionQuery): Snippet = Snippet(query.host, query.collection, query.docId, query.location, query.size + 10, "http://www.google.com", AnnotatedText(loremOneSentence, emptyMap(), emptyList(), emptyList()), Math.random() > 0.4)
