...
class QueryService {
    ...
    fun context(query: ContextExtensionQuery): Match = Match(query.collection, 42, query.location.toInt(), query.size.toInt() + 10, "http://www.google.com", "title", Payload.Snippet.Json(AnnotatedText(loremOneSentence, emptyMap(), emptyList(), emptyList())), Math.random() > 0.4)
