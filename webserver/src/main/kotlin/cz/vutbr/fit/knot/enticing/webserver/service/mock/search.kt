...
val firstResult = WebServer.SearchResult(
        ...
        payload = ResultFormat.Snippet.StringWithMetadata(
                StringWithMetadata(
                        ...
                        positions = setOf(AnnotationPosition("ed", MatchedRegion(0, 10))),
                        queryMapping = setOf(QueryMapping(textIndex = MatchedRegion(0, 10), queryIndex = MatchedRegion(0, 5)))
                ),
                10, 20, false
        ),
...
val secondResult = WebServer.SearchResult(
        ...
        payload = ResultFormat.Snippet.StringWithMetadata(
                StringWithMetadata(
                        ...
                        positions = setOf(AnnotationPosition("donald", MatchedRegion(10, 12))),
                        queryMapping = setOf(QueryMapping(MatchedRegion(0, 16), MatchedRegion(0, 5)))
                ), 10, 20, false
        ),
...
val thirdResult = WebServer.SearchResult(
        ...
        payload = ResultFormat.Snippet.StringWithMetadata(
                StringWithMetadata(
                        ...
                        positions = setOf(AnnotationPosition("kv", MatchedRegion(114, 13))),
                        queryMapping = setOf(QueryMapping(MatchedRegion(117, 23), MatchedRegion(0, 5)))
                ),
                10, 20, false
        ),
...
fun randomResult() = results[floor(Math.random() * results.size).toInt()]
